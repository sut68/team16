    ...
    <div class="max-w-5xl mx-auto p-6">
      ...
      <div class="bg-white shadow rounded-lg p-6 mb-6">
        ...
        <div v-if="role === 'admin'" class="grid grid-cols-2 gap-6">
          <div class="form-control"><label class="label font-bold">ชื่อจริง</label><input v-model="profile.admin_first_name" :disabled="!isEditing" class="input input-bordered"/></div>
          <div class="form-control"><label class="label font-bold">นามสกุล</label><input v-model="profile.admin_last_name" :disabled="!isEditing" class="input input-bordered"/></div>
