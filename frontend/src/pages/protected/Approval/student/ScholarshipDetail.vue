            ...
            <div class="flex flex-col md:flex-row gap-4">
              <div class="flex-1">
                <div class="flex items-center gap-3 mb-2">
                  <span class="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-1 rounded-full">{{ scholarship.typescholarship?.type_name || 'ทั่วไป' }}</span>
                  <span class="text-xs text-gray-400">ปิดรับสมัคร: {{ new Date(scholarship.close_date).toLocaleDateString('th-TH') }}</span>
                </div>
              ...
              <div class="flex-shrink-0 flex flex-col items-center justify-center gap-2 border-l-0 md:border-l md:pl-4 mt-4 md:mt-0 pt-4 md:pt-0 border-t md:border-t-0">
