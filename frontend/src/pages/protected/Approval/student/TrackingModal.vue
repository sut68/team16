        ...
        <div
            ...
            <div class="bg-[#1e3a8a] px-6 py-4 shrink-0 flex justify-between items-start">
                <div>
                    ...
                    <p class="text-blue-200 text-sm mt-1">{{ applicationData.scholarship?.scholarship_name ||
                        'รายละเอียดทุน' }}</p>
                </div>
                    ...
                    <div v-for="(stage, index) in stages" :key="stage.id" class="relative pb-10 last:pb-0">
                        ...
                        <div class="relative flex items-start gap-4 z-10">
                            <div class="relative flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center border-2 font-bold transition-all bg-white shadow-sm"
                                ...
                                <svg v-if="getStepStatus(stage.id) === 'completed'" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="flex-1 pt-1">
                                <div class="flex flex-wrap justify-between items-start gap-2">
                                    <div>
                                        <h4 class="font-bold text-base" :class="{
                                    ...
                                    <div class="shrink-0">
                                        <span v-if="getStepStatus(stage.id) === 'completed'"
                                            class="badge badge-success text-white badge-sm">เสร็จสิ้น</span>
                                        <span v-else-if="['current', 'process'].includes(getStepStatus(stage.id))"
                                            class="badge badge-info text-white badge-sm animate-pulse">กำลังดำเนินการ</span>
                                        <span v-else-if="getStepStatus(stage.id) === 'action-needed'"
                                            class="badge badge-primary badge-outline badge-sm">รอคุณดำเนินการ</span>
                                        <span v-else-if="getStepStatus(stage.id) === 'request-change'"
                                            class="badge badge-warning text-white badge-sm">ต้องแก้ไข</span>
                                        <span v-else-if="getStepStatus(stage.id) === 'rejected'"
                                            class="badge badge-error text-white badge-sm">ไม่ผ่าน</span>
                                    </div>
                                </div>
                                ...
                                <div class="mt-3 animate-fade-in">
                                    ...
                                    <div v-if="stage.id === 3">
                                        <div v-if="getStepStatus(3) === 'action-needed'"
                                        ...
                                        <div v-if="getStepStatus(3) === 'request-change'"
                                            ...
                                            <div class="flex items-start gap-3 mb-3">
                                                <div class="bg-orange-100 p-2 rounded-full shrink-0">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        class="h-5 w-5 text-orange-600" fill="none" viewBox="0 0 24 24"
                                                        stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2"
                                    ...
                                    <div v-if="stage.id === 5 && ['action-needed', 'current'].includes(getStepStatus(5))"
                                        ...
                                        <div class="flex items-center gap-3 mb-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xs text-green-700">กรุณาจองคิวสัมภาษณ์เพื่อดำเนินการต่อ
                                                </p>
                                            </div>
                                        </div>
            ...
            <div class="p-4 bg-gray-50 border-t text-center shrink-0">
                <button @click="$emit('close')"
                    class="btn btn-ghost w-full max-w-xs text-gray-500 font-normal">ปิดหน้าต่าง</button>
            </div>
        </div>
    </div>
</template>
